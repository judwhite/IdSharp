...
namespace IdSharp.Tagging.Mpeg4
{
    ...
    internal class Mpeg4Tag : INotifyPropertyChanged
    {
        ...
        public int TotalTracks
        {
            ...
            {
                _totalTracks = value;
                SendPropertyChanged("TotalTracks");
            }
        }
        ...
        public bool IsPartOfCompilation
        {
            ...
            set
            {
                ...
                SendPropertyChanged("IsPartOfCompilation");
            }
        }
        ...
        public int TotalDiscs
        {
            ...
            {
                _totalDiscs = value;
                SendPropertyChanged("TotalDiscs");
            }
        }
